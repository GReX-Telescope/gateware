...
module fifo(w_en, r_en, r_data, clk, w_data);
...
module packetizer(ce, sync_in, ch_a_in, ch_b_in, tx_data, tx_valid, tx_eof, rst);
...
module unbuffered(w_data, w_en, w_rdy, r_data, r_en, r_rdy, level, clk);
